...
enum Fields {
  mainMenu('Main Menu',
      description: 'Select which menu to show when the application starts'),
  mainHotkey('Shortcut',
      description: 'Global shortcut key combination to open the main menu'),
  name('Name',
      description: 'Name of the menu - must be unique across all menus'),
  type('Type',
      description:
          'Menu display style - either wheel (circular) or list (vertical) layout'),
  menuHotkey('Shortcut',
      description: 'Shortcut key combination to open this specific menu'),
  theme('Theme',
      description:
          'Visual theme for the menu - use default or select a custom theme'),
  colorScheme('Color Scheme',
      description:
          'Choose between light, dark, or system color scheme for the menu'),
  width('Width',
      description:
          'Width of the menu in pixels (px) or percentage (%) of screen width'),
  height('Height',
      description:
          'Height of the menu in pixels (px) or percentage (%) of screen height'),
  position('Position',
      description:
          'Menu position on screen - can be relative to mouse cursor or fixed position with vertical/horizontal alignment'),
  marginVertical('Margin Vertical',
      description:
          'Vertical margin from the top/bottom of the screen in pixels (px) or percentage (%)'),
  marginHorizontal('Margin Horizontal',
      description:
          'Horizontal margin from the left/right of the screen in pixels (px) or percentage (%)'),
  monitor('Monitor',
      description:
          'Select which monitor to display the menu on - auto or specific display'),
  ...
  itemName('Name',
      description:
          'Name of the menu item - displayed as the primary text, this can be overridden in the plugin'),
  itemDescription('Description',
      description:
          'Optional description text shown below the item name, this can be overridden in the plugin'),
  itemRepeat('Repetition',
      description:
          'Item(s) can be repeated without closing the menu after being used'),
  itemShortcut('Hotkey',
      description:
          'Override the auto-generated hotkey of the element. If plugin generates more than one element, the hotkey will filter the elements generated by this plugin'),
  itemIcon('Icon',
      description:
          'Override the icon of the element - set empty to let plugin set the icon. Can be a Font Awesome icon or local image'),
  itemPlugin('Plugin',
      description:
          'Select the plugin to generate the element(s) - determines the action when item is selected'),
  itemPluginArg('',
      description:
          'Arguments passed to the selected plugin - varies based on plugin type');
