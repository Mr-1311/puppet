...
enum Fields {
  ...
  itemRepeat('Repetition', description: 'Item(s) can be repeated without closing the menu after used'),
  itemShortcut('Hotkey',
      description:
  ...
  itemIcon('Icon', description: 'Override the icon of the element, set empty to let plugin set the icon'),
  itemPlugin('Plugin', description: 'Select the plugin to generate the element(s)'),
  itemPluginArg(''),
  ;
...
class _SettingsElementState extends ConsumerState<SettingsElement> {
  ...
  Future<bool> _pickFile(BuildContext context) async {
    ...
    if (result != null && result.files.isNotEmpty) {
      File? file = null;
      try {
        file = await File('${getAppDirs(application: 'puppet').config}/icons/${result.files.first.name}')
  ...
  _pickImage(BuildContext context) {
    Directory directory = Directory('${getAppDirs(application: 'puppet').config}/icons');
